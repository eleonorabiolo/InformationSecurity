...
To do this, you will already need a VirtualBox. This task has been completed in class. To ensure that your environment is functioning, open the browser and perform a search. If it works, you can proceed with the task below.
...
```
![image](https://github.com/eleonorabiolo/InformationSecurity/assets/71267403/3d150262-2e95-4f2f-b0c3-b278fc04522b)

```
- Perform your search
```
![image](https://github.com/eleonorabiolo/InformationSecurity/assets/71267403/d02552e6-267b-4353-92cb-9417cf3dbeeb)

Good job, it works ! Let's start
...
After the last course (28.08.23) we find a solution.

```
Enter the standard credentials 
Username : user
Password : live
```

![image](https://github.com/eleonorabiolo/InformationSecurity/assets/71267403/2c83eb3e-c43e-415e-8341-b1207ddbaa65)

```
Shot down the virtual machine
```

![image](https://github.com/eleonorabiolo/InformationSecurity/assets/71267403/642e3437-da0d-4c00-b8d6-62a1f3abc1b8)

```
Now you can restart the virtual machine and enter your credentials
```

![image](https://github.com/eleonorabiolo/InformationSecurity/assets/71267403/c3db3a9a-a7f8-4bf5-822f-650d8409171b)

```
As you can see below, the Debian icon is no longer present, and you are now connected with your account.
```

![image](https://github.com/eleonorabiolo/InformationSecurity/assets/71267403/5d3048f3-e399-4f96-87b2-143820b265bc)
